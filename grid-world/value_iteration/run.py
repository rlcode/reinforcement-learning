...
class GraphicEnv(tk.Tk):
    def __init__(self):
        super(GraphicEnv, self).__init__()
        self.action_space = ['u', 'd', 'l', 'r']
        self.n_actions = len(self.action_space)
        self.title('ValueIteration')
    ...
    def _build_env(self):
        ...
        iterationButton = tk.Button(self, text="Iterate", command=self.do_iteration)
