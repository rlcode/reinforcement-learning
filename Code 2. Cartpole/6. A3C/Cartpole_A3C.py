...
# In this example, we use A3C algorithm (refer : https://arxiv.org/pdf/1602.01783.pdf)
class A3CAgent:
    def __init__(self, state_size, action_size, env_name):
        ...
        # method for training actor and critic
    ...
    # we add cross-entropy of action probability to loss
