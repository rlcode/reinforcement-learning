...
from tensorflow.python.ops.string_ops import string_length as length
from tensorflow.python.ops.string_ops import string_to_hash_bucket_v1 as to_hash_bucket
from tensorflow.python.ops.string_ops import string_to_number_v1 as to_number
from tensorflow.python.ops.string_ops import substr
...
if not isinstance(_sys.modules[__name__], _module_wrapper.TFModuleWrapper):
  _sys.modules[__name__] = _module_wrapper.TFModuleWrapper(
      _sys.modules[__name__], "compat.v1.strings", public_apis=None, deprecation=False,
      has_lite=False)
