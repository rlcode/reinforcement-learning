...
from tensorflow._api.v1.compat.v1.train import experimental
from tensorflow._api.v1.compat.v1.train import queue_runner
...
if not isinstance(_sys.modules[__name__], _module_wrapper.TFModuleWrapper):
  _sys.modules[__name__] = _module_wrapper.TFModuleWrapper(
      _sys.modules[__name__], "compat.v1.train", public_apis=None, deprecation=False,
      has_lite=False)
