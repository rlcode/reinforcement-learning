  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "CreateTreeVariable", name, _ctx.post_execution_callbacks,
...
def CreateTreeVariable(tree_handle, tree_config, params, name=None):
  return create_tree_variable(tree_handle=tree_handle, tree_config=tree_config, params=params, name=name)
CreateTreeVariable.__doc__ = create_tree_variable.__doc__
CreateTreeVariable = _doc_controls.do_not_generate_docs(_kwarg_only(CreateTreeVariable))
tf_export("raw_ops.CreateTreeVariable")(CreateTreeVariable)
...
def decision_tree_resource_handle_op(container="", shared_name="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DecisionTreeResourceHandleOp", name, _ctx.post_execution_callbacks,
...
def DecisionTreeResourceHandleOp(container="", shared_name="", name=None):
  return decision_tree_resource_handle_op(container=container, shared_name=shared_name, name=name)
DecisionTreeResourceHandleOp.__doc__ = decision_tree_resource_handle_op.__doc__
DecisionTreeResourceHandleOp = _doc_controls.do_not_generate_docs(_kwarg_only(DecisionTreeResourceHandleOp))
tf_export("raw_ops.DecisionTreeResourceHandleOp")(DecisionTreeResourceHandleOp)
...
def feature_usage_counts(tree_handle, params, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "FeatureUsageCounts", name, _ctx.post_execution_callbacks,
...
def FeatureUsageCounts(tree_handle, params, name=None):
  return feature_usage_counts(tree_handle=tree_handle, params=params, name=name)
FeatureUsageCounts.__doc__ = feature_usage_counts.__doc__
FeatureUsageCounts = _doc_controls.do_not_generate_docs(_kwarg_only(FeatureUsageCounts))
tf_export("raw_ops.FeatureUsageCounts")(FeatureUsageCounts)
...
def traverse_tree_v4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TraverseTreeV4", name, _ctx.post_execution_callbacks, tree_handle,
...
def TraverseTreeV4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params, name=None):
  return traverse_tree_v4(tree_handle=tree_handle, input_data=input_data, sparse_input_indices=sparse_input_indices, sparse_input_values=sparse_input_values, sparse_input_shape=sparse_input_shape, input_spec=input_spec, params=params, name=name)
TraverseTreeV4.__doc__ = traverse_tree_v4.__doc__
TraverseTreeV4 = _doc_controls.do_not_generate_docs(_kwarg_only(TraverseTreeV4))
tf_export("raw_ops.TraverseTreeV4")(TraverseTreeV4)
...
def tree_deserialize(tree_handle, tree_config, params, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TreeDeserialize", name, _ctx.post_execution_callbacks, tree_handle,
...
def TreeDeserialize(tree_handle, tree_config, params, name=None):
  return tree_deserialize(tree_handle=tree_handle, tree_config=tree_config, params=params, name=name)
TreeDeserialize.__doc__ = tree_deserialize.__doc__
TreeDeserialize = _doc_controls.do_not_generate_docs(_kwarg_only(TreeDeserialize))
tf_export("raw_ops.TreeDeserialize")(TreeDeserialize)
...
def tree_is_initialized_op(tree_handle, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TreeIsInitializedOp", name, _ctx.post_execution_callbacks,
        tree_handle)
      return _result
    except _core._FallbackException:
      try:
...
def TreeIsInitializedOp(tree_handle, name=None):
  return tree_is_initialized_op(tree_handle=tree_handle, name=name)
TreeIsInitializedOp.__doc__ = tree_is_initialized_op.__doc__
TreeIsInitializedOp = _doc_controls.do_not_generate_docs(_kwarg_only(TreeIsInitializedOp))
tf_export("raw_ops.TreeIsInitializedOp")(TreeIsInitializedOp)
...
def tree_predictions_v4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TreePredictionsV4", name, _ctx.post_execution_callbacks, tree_handle,
        input_data, sparse_input_indices, sparse_input_values,
        sparse_input_shape, "input_spec", input_spec, "params", params)
...
def TreePredictionsV4(tree_handle, input_data, sparse_input_indices, sparse_input_values, sparse_input_shape, input_spec, params, name=None):
  return tree_predictions_v4(tree_handle=tree_handle, input_data=input_data, sparse_input_indices=sparse_input_indices, sparse_input_values=sparse_input_values, sparse_input_shape=sparse_input_shape, input_spec=input_spec, params=params, name=name)
TreePredictionsV4.__doc__ = tree_predictions_v4.__doc__
TreePredictionsV4 = _doc_controls.do_not_generate_docs(_kwarg_only(TreePredictionsV4))
tf_export("raw_ops.TreePredictionsV4")(TreePredictionsV4)
...
def tree_serialize(tree_handle, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TreeSerialize", name, _ctx.post_execution_callbacks, tree_handle)
      return _result
    except _core._FallbackException:
      try:
...
def TreeSerialize(tree_handle, name=None):
  return tree_serialize(tree_handle=tree_handle, name=name)
TreeSerialize.__doc__ = tree_serialize.__doc__
TreeSerialize = _doc_controls.do_not_generate_docs(_kwarg_only(TreeSerialize))
tf_export("raw_ops.TreeSerialize")(TreeSerialize)
...
def tree_size(tree_handle, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name, "TreeSize",
        name, _ctx.post_execution_callbacks, tree_handle)
      return _result
    except _core._FallbackException:
      try:
...
def TreeSize(tree_handle, name=None):
  return tree_size(tree_handle=tree_handle, name=name)
TreeSize.__doc__ = tree_size.__doc__
TreeSize = _doc_controls.do_not_generate_docs(_kwarg_only(TreeSize))
tf_export("raw_ops.TreeSize")(TreeSize)
...
def update_model_v4(tree_handle, leaf_ids, input_labels, input_weights, params, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "UpdateModelV4", name, _ctx.post_execution_callbacks, tree_handle,
...
def UpdateModelV4(tree_handle, leaf_ids, input_labels, input_weights, params, name=None):
  return update_model_v4(tree_handle=tree_handle, leaf_ids=leaf_ids, input_labels=input_labels, input_weights=input_weights, params=params, name=name)
UpdateModelV4.__doc__ = update_model_v4.__doc__
UpdateModelV4 = _doc_controls.do_not_generate_docs(_kwarg_only(UpdateModelV4))
tf_export("raw_ops.UpdateModelV4")(UpdateModelV4)
