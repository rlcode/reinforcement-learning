  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "ReinterpretStringToFloat", name, _ctx.post_execution_callbacks,
        input_data)
      return _result
...
ReinterpretStringToFloat = _doc_controls.do_not_generate_docs(_kwarg_only(ReinterpretStringToFloat))
...
def ScatterAddNdim(input, indices, deltas, name=None):
  return scatter_add_ndim(input=input, indices=indices, deltas=deltas, name=name)
ScatterAddNdim.__doc__ = scatter_add_ndim.__doc__
ScatterAddNdim = _doc_controls.do_not_generate_docs(_kwarg_only(ScatterAddNdim))
tf_export("raw_ops.ScatterAddNdim")(ScatterAddNdim)
