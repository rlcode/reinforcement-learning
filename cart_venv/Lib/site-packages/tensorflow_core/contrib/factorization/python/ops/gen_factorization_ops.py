  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "MaskedMatmul", name, _ctx.post_execution_callbacks, a, b,
...
def wals_compute_partial_lhs_and_rhs(factors, factor_weights, unobserved_weights, input_weights, input_indices, input_values, entry_weights, input_block_size, input_is_transpose, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WALSComputePartialLhsAndRhs", name, _ctx.post_execution_callbacks,
...
def WALSComputePartialLhsAndRhs(factors, factor_weights, unobserved_weights, input_weights, input_indices, input_values, entry_weights, input_block_size, input_is_transpose, name=None):
  return wals_compute_partial_lhs_and_rhs(factors=factors, factor_weights=factor_weights, unobserved_weights=unobserved_weights, input_weights=input_weights, input_indices=input_indices, input_values=input_values, entry_weights=entry_weights, input_block_size=input_block_size, input_is_transpose=input_is_transpose, name=name)
WALSComputePartialLhsAndRhs.__doc__ = wals_compute_partial_lhs_and_rhs.__doc__
WALSComputePartialLhsAndRhs = _doc_controls.do_not_generate_docs(_kwarg_only(WALSComputePartialLhsAndRhs))
tf_export("raw_ops.WALSComputePartialLhsAndRhs")(WALSComputePartialLhsAndRhs)
