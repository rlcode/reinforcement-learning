  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "RemoteFusedGraphExecute", name, _ctx.post_execution_callbacks,
...
def RemoteFusedGraphExecute(inputs, Toutputs, serialized_remote_fused_graph_execute_info, name=None):
  return remote_fused_graph_execute(inputs=inputs, Toutputs=Toutputs, serialized_remote_fused_graph_execute_info=serialized_remote_fused_graph_execute_info, name=name)
RemoteFusedGraphExecute.__doc__ = remote_fused_graph_execute.__doc__
RemoteFusedGraphExecute = _doc_controls.do_not_generate_docs(_kwarg_only(RemoteFusedGraphExecute))
tf_export("raw_ops.RemoteFusedGraphExecute")(RemoteFusedGraphExecute)
