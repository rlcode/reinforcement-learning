  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "BytesInUse", name, _ctx.post_execution_callbacks)
      return _result
...
def BytesInUse(name=None):
  return bytes_in_use(name=name)
BytesInUse.__doc__ = bytes_in_use.__doc__
BytesInUse = _doc_controls.do_not_generate_docs(_kwarg_only(BytesInUse))
tf_export("raw_ops.BytesInUse")(BytesInUse)
...
def bytes_limit(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "BytesLimit", name, _ctx.post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
def BytesLimit(name=None):
  return bytes_limit(name=name)
BytesLimit.__doc__ = bytes_limit.__doc__
BytesLimit = _doc_controls.do_not_generate_docs(_kwarg_only(BytesLimit))
tf_export("raw_ops.BytesLimit")(BytesLimit)
...
def max_bytes_in_use(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MaxBytesInUse", name, _ctx.post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
def MaxBytesInUse(name=None):
  return max_bytes_in_use(name=name)
MaxBytesInUse.__doc__ = max_bytes_in_use.__doc__
MaxBytesInUse = _doc_controls.do_not_generate_docs(_kwarg_only(MaxBytesInUse))
tf_export("raw_ops.MaxBytesInUse")(MaxBytesInUse)
