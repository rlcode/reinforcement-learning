...
def single_image_random_dot_stereograms(depth_values, hidden_surface_removal=True, convergence_dots_size=8, dots_per_inch=72, eye_separation=2.5, mu=0.3333, normalize=True, normalize_max=-100, normalize_min=100, border_level=0, number_colors=256, output_image_shape=[1024, 768, 1], output_data_window=[1022, 757], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx.post_execution_callbacks, depth_values, "hidden_surface_removal",
        hidden_surface_removal, "convergence_dots_size",
        convergence_dots_size, "dots_per_inch", dots_per_inch,
        "eye_separation", eye_separation, "mu", mu, "normalize", normalize,
  ...
  _attrs = ("T", _op._get_attr_type("T"), "hidden_surface_removal",
...
def SingleImageRandomDotStereograms(depth_values, hidden_surface_removal=True, convergence_dots_size=8, dots_per_inch=72, eye_separation=2.5, mu=0.3333, normalize=True, normalize_max=-100, normalize_min=100, border_level=0, number_colors=256, output_image_shape=[1024, 768, 1], output_data_window=[1022, 757], name=None):
  return single_image_random_dot_stereograms(depth_values=depth_values, hidden_surface_removal=hidden_surface_removal, convergence_dots_size=convergence_dots_size, dots_per_inch=dots_per_inch, eye_separation=eye_separation, mu=mu, normalize=normalize, normalize_max=normalize_max, normalize_min=normalize_min, border_level=border_level, number_colors=number_colors, output_image_shape=output_image_shape, output_data_window=output_data_window, name=name)
SingleImageRandomDotStereograms.__doc__ = single_image_random_dot_stereograms.__doc__
SingleImageRandomDotStereograms = _doc_controls.do_not_generate_docs(_kwarg_only(SingleImageRandomDotStereograms))
tf_export("raw_ops.SingleImageRandomDotStereograms")(SingleImageRandomDotStereograms)
