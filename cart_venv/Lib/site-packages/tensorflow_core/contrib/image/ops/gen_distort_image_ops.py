...
def AdjustHsvInYiq(images, delta_h, scale_s, scale_v, name=None):
  return adjust_hsv_in_yiq(images=images, delta_h=delta_h, scale_s=scale_s, scale_v=scale_v, name=name)
AdjustHsvInYiq.__doc__ = adjust_hsv_in_yiq.__doc__
AdjustHsvInYiq = _doc_controls.do_not_generate_docs(_kwarg_only(AdjustHsvInYiq))
