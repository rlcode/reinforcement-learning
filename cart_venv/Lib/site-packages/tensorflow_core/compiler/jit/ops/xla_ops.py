  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "XlaClusterOutput", name, _ctx.post_execution_callbacks, input)
      return _result
...
def xla_launch(constants, args, resources, Tresults, function, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "XlaLaunch", name, _ctx.post_execution_callbacks, constants, args,
        resources, "Tresults", Tresults, "function", function)
      return _result
    except _core._FallbackException:
      try:
...
def XlaLaunch(constants, args, resources, Tresults, function, name=None):
  return xla_launch(constants=constants, args=args, resources=resources, Tresults=Tresults, function=function, name=name)
XlaLaunch.__doc__ = xla_launch.__doc__
XlaLaunch = _doc_controls.do_not_generate_docs(_kwarg_only(XlaLaunch))
tf_export("raw_ops.XlaLaunch")(XlaLaunch)
