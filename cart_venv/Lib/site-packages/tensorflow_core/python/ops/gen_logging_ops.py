  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx.post_execution_callbacks, condition, data, "summarize",
        summarize)
      return _result
...
def Assert(condition, data, summarize=3, name=None):
  return _assert(condition=condition, data=data, summarize=summarize, name=name)
Assert.__doc__ = _assert.__doc__
Assert = _doc_controls.do_not_generate_docs(_kwarg_only(Assert))
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "AudioSummary", name, _ctx.post_execution_callbacks, tag, tensor,
...
def AudioSummary(tag, tensor, sample_rate, max_outputs=3, name=None):
  return audio_summary(tag=tag, tensor=tensor, sample_rate=sample_rate, max_outputs=max_outputs, name=name)
AudioSummary.__doc__ = audio_summary.__doc__
AudioSummary = _doc_controls.do_not_generate_docs(_kwarg_only(AudioSummary))
  ...
  *  If `max_outputs` is greater than 1, the summary value tags are
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "AudioSummaryV2", name, _ctx.post_execution_callbacks, tag, tensor,
...
def AudioSummaryV2(tag, tensor, sample_rate, max_outputs=3, name=None):
  return audio_summary_v2(tag=tag, tensor=tensor, sample_rate=sample_rate, max_outputs=max_outputs, name=name)
AudioSummaryV2.__doc__ = audio_summary_v2.__doc__
AudioSummaryV2 = _doc_controls.do_not_generate_docs(_kwarg_only(AudioSummaryV2))
...
def histogram_summary(tag, values, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "HistogramSummary", name, _ctx.post_execution_callbacks, tag, values)
      return _result
    except _core._FallbackException:
      try:
...
def HistogramSummary(tag, values, name=None):
  return histogram_summary(tag=tag, values=values, name=name)
HistogramSummary.__doc__ = histogram_summary.__doc__
HistogramSummary = _doc_controls.do_not_generate_docs(_kwarg_only(HistogramSummary))
  ...
  *  If `max_images` is greater than 1, the summary value tags are
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ImageSummary", name, _ctx.post_execution_callbacks, tag, tensor,
...
def ImageSummary(tag, tensor, max_images=3, bad_color=_execute.make_tensor("""dtype: DT_UINT8 tensor_shape { dim { size: 4 } } int_val: 255 int_val: 0 int_val: 0 int_val: 255""", "bad_color"), name=None):
  return image_summary(tag=tag, tensor=tensor, max_images=max_images, bad_color=bad_color, name=name)
ImageSummary.__doc__ = image_summary.__doc__
ImageSummary = _doc_controls.do_not_generate_docs(_kwarg_only(ImageSummary))
...
def merge_summary(inputs, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "MergeSummary", name, _ctx.post_execution_callbacks, inputs)
      return _result
    except _core._FallbackException:
      try:
...
def MergeSummary(inputs, name=None):
  return merge_summary(inputs=inputs, name=name)
MergeSummary.__doc__ = merge_summary.__doc__
MergeSummary = _doc_controls.do_not_generate_docs(_kwarg_only(MergeSummary))
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx.post_execution_callbacks, input, data, "message", message,
...
def Print(input, data, message="", first_n=-1, summarize=3, name=None):
  return _print(input=input, data=data, message=message, first_n=first_n, summarize=summarize, name=name)
Print.__doc__ = _print.__doc__
Print = _doc_controls.do_not_generate_docs(_kwarg_only(Print))
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        name, _ctx.post_execution_callbacks, input, "output_stream",
        output_stream, "end", end)
      return _result
    except _core._FallbackException:
      try:
...
def PrintV2(input, output_stream="stderr", end="\n", name=None):
  return print_v2(input=input, output_stream=output_stream, end=end, name=name)
PrintV2.__doc__ = print_v2.__doc__
PrintV2 = _doc_controls.do_not_generate_docs(_kwarg_only(PrintV2))
tf_export("raw_ops.PrintV2")(PrintV2)


def print_v2_eager_fallback(input, output_stream="stderr", end="\n", name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
...
def scalar_summary(tags, values, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ScalarSummary", name, _ctx.post_execution_callbacks, tags, values)
      return _result
    except _core._FallbackException:
      try:
...
def ScalarSummary(tags, values, name=None):
  return scalar_summary(tags=tags, values=values, name=name)
ScalarSummary.__doc__ = scalar_summary.__doc__
ScalarSummary = _doc_controls.do_not_generate_docs(_kwarg_only(ScalarSummary))
...
def tensor_summary(tensor, description="", labels=[], display_name="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TensorSummary", name, _ctx.post_execution_callbacks, tensor,
...
def TensorSummary(tensor, description="", labels=[], display_name="", name=None):
  return tensor_summary(tensor=tensor, description=description, labels=labels, display_name=display_name, name=name)
TensorSummary.__doc__ = tensor_summary.__doc__
TensorSummary = _doc_controls.do_not_generate_docs(_kwarg_only(TensorSummary))
...
def tensor_summary_v2(tag, tensor, serialized_summary_metadata, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "TensorSummaryV2", name, _ctx.post_execution_callbacks, tag, tensor,
...
def TensorSummaryV2(tag, tensor, serialized_summary_metadata, name=None):
  return tensor_summary_v2(tag=tag, tensor=tensor, serialized_summary_metadata=serialized_summary_metadata, name=name)
TensorSummaryV2.__doc__ = tensor_summary_v2.__doc__
TensorSummaryV2 = _doc_controls.do_not_generate_docs(_kwarg_only(TensorSummaryV2))
...
def timestamp(name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "Timestamp", name, _ctx.post_execution_callbacks)
      return _result
    except _core._FallbackException:
      try:
...
Timestamp.__doc__ = timestamp.__doc__
Timestamp = _doc_controls.do_not_generate_docs(_kwarg_only(Timestamp))
