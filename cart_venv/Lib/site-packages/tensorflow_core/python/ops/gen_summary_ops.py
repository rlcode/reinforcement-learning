  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "CloseSummaryWriter", name, _ctx.post_execution_callbacks, writer)
      return _result
...
def CloseSummaryWriter(writer, name=None):
  return close_summary_writer(writer=writer, name=name)
CloseSummaryWriter.__doc__ = close_summary_writer.__doc__
CloseSummaryWriter = _doc_controls.do_not_generate_docs(_kwarg_only(CloseSummaryWriter))
...
def create_summary_db_writer(writer, db_uri, experiment_name, run_name, user_name, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "CreateSummaryDbWriter", name, _ctx.post_execution_callbacks, writer,
...
def CreateSummaryDbWriter(writer, db_uri, experiment_name, run_name, user_name, name=None):
  return create_summary_db_writer(writer=writer, db_uri=db_uri, experiment_name=experiment_name, run_name=run_name, user_name=user_name, name=name)
CreateSummaryDbWriter.__doc__ = create_summary_db_writer.__doc__
CreateSummaryDbWriter = _doc_controls.do_not_generate_docs(_kwarg_only(CreateSummaryDbWriter))
...
def create_summary_file_writer(writer, logdir, max_queue, flush_millis, filename_suffix, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "CreateSummaryFileWriter", name, _ctx.post_execution_callbacks,
...
def CreateSummaryFileWriter(writer, logdir, max_queue, flush_millis, filename_suffix, name=None):
  return create_summary_file_writer(writer=writer, logdir=logdir, max_queue=max_queue, flush_millis=flush_millis, filename_suffix=filename_suffix, name=name)
CreateSummaryFileWriter.__doc__ = create_summary_file_writer.__doc__
CreateSummaryFileWriter = _doc_controls.do_not_generate_docs(_kwarg_only(CreateSummaryFileWriter))
...
def flush_summary_writer(writer, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "FlushSummaryWriter", name, _ctx.post_execution_callbacks, writer)
      return _result
    except _core._FallbackException:
      try:
...
def FlushSummaryWriter(writer, name=None):
  return flush_summary_writer(writer=writer, name=name)
FlushSummaryWriter.__doc__ = flush_summary_writer.__doc__
FlushSummaryWriter = _doc_controls.do_not_generate_docs(_kwarg_only(FlushSummaryWriter))
...
def import_event(writer, event, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ImportEvent", name, _ctx.post_execution_callbacks, writer, event)
      return _result
    except _core._FallbackException:
      try:
...
def ImportEvent(writer, event, name=None):
  return import_event(writer=writer, event=event, name=name)
ImportEvent.__doc__ = import_event.__doc__
ImportEvent = _doc_controls.do_not_generate_docs(_kwarg_only(ImportEvent))
...
def summary_writer(shared_name="", container="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SummaryWriter", name, _ctx.post_execution_callbacks, "shared_name",
...
def SummaryWriter(shared_name="", container="", name=None):
  return summary_writer(shared_name=shared_name, container=container, name=name)
SummaryWriter.__doc__ = summary_writer.__doc__
SummaryWriter = _doc_controls.do_not_generate_docs(_kwarg_only(SummaryWriter))
...
def write_audio_summary(writer, step, tag, tensor, sample_rate, max_outputs=3, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteAudioSummary", name, _ctx.post_execution_callbacks, writer,
...
def WriteAudioSummary(writer, step, tag, tensor, sample_rate, max_outputs=3, name=None):
  return write_audio_summary(writer=writer, step=step, tag=tag, tensor=tensor, sample_rate=sample_rate, max_outputs=max_outputs, name=name)
WriteAudioSummary.__doc__ = write_audio_summary.__doc__
WriteAudioSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteAudioSummary))
...
def write_graph_summary(writer, step, tensor, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteGraphSummary", name, _ctx.post_execution_callbacks, writer,
        step, tensor)
      return _result
    except _core._FallbackException:
      try:
...
def WriteGraphSummary(writer, step, tensor, name=None):
  return write_graph_summary(writer=writer, step=step, tensor=tensor, name=name)
WriteGraphSummary.__doc__ = write_graph_summary.__doc__
WriteGraphSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteGraphSummary))
...
def write_histogram_summary(writer, step, tag, values, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteHistogramSummary", name, _ctx.post_execution_callbacks, writer,
        step, tag, values)
      return _result
    except _core._FallbackException:
      try:
...
def WriteHistogramSummary(writer, step, tag, values, name=None):
  return write_histogram_summary(writer=writer, step=step, tag=tag, values=values, name=name)
WriteHistogramSummary.__doc__ = write_histogram_summary.__doc__
WriteHistogramSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteHistogramSummary))
...
def write_image_summary(writer, step, tag, tensor, bad_color, max_images=3, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteImageSummary", name, _ctx.post_execution_callbacks, writer,
...
def WriteImageSummary(writer, step, tag, tensor, bad_color, max_images=3, name=None):
  return write_image_summary(writer=writer, step=step, tag=tag, tensor=tensor, bad_color=bad_color, max_images=max_images, name=name)
WriteImageSummary.__doc__ = write_image_summary.__doc__
WriteImageSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteImageSummary))
...
def write_raw_proto_summary(writer, step, tensor, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteRawProtoSummary", name, _ctx.post_execution_callbacks, writer,
        step, tensor)
      return _result
    except _core._FallbackException:
      try:
...
def WriteRawProtoSummary(writer, step, tensor, name=None):
  return write_raw_proto_summary(writer=writer, step=step, tensor=tensor, name=name)
WriteRawProtoSummary.__doc__ = write_raw_proto_summary.__doc__
WriteRawProtoSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteRawProtoSummary))
tf_export("raw_ops.WriteRawProtoSummary")(WriteRawProtoSummary)


def write_raw_proto_summary_eager_fallback(writer, step, tensor, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function write_raw_proto_summary
  """
  _ctx = ctx if ctx else _context.context()
  writer = _ops.convert_to_tensor(writer, _dtypes.resource)
  step = _ops.convert_to_tensor(step, _dtypes.int64)
...
def write_scalar_summary(writer, step, tag, value, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteScalarSummary", name, _ctx.post_execution_callbacks, writer,
        step, tag, value)
      return _result
    except _core._FallbackException:
      try:
...
def WriteScalarSummary(writer, step, tag, value, name=None):
  return write_scalar_summary(writer=writer, step=step, tag=tag, value=value, name=name)
WriteScalarSummary.__doc__ = write_scalar_summary.__doc__
WriteScalarSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteScalarSummary))
...
def write_summary(writer, step, tensor, tag, summary_metadata, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "WriteSummary", name, _ctx.post_execution_callbacks, writer, step,
...
def WriteSummary(writer, step, tensor, tag, summary_metadata, name=None):
  return write_summary(writer=writer, step=step, tensor=tensor, tag=tag, summary_metadata=summary_metadata, name=name)
WriteSummary.__doc__ = write_summary.__doc__
WriteSummary = _doc_controls.do_not_generate_docs(_kwarg_only(WriteSummary))
