  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        "DecodeCSV", name, _ctx.post_execution_callbacks, records,
...
def DecodeCSV(records, record_defaults, field_delim=",", use_quote_delim=True, na_value="", select_cols=[], name=None):
  return decode_csv(records=records, record_defaults=record_defaults, field_delim=field_delim, use_quote_delim=use_quote_delim, na_value=na_value, select_cols=select_cols, name=name)
DecodeCSV.__doc__ = decode_csv.__doc__
DecodeCSV = _doc_controls.do_not_generate_docs(_kwarg_only(DecodeCSV))
...
def decode_compressed(bytes, compression_type="", name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DecodeCompressed", name, _ctx.post_execution_callbacks, bytes,
...
def DecodeCompressed(bytes, compression_type="", name=None):
  return decode_compressed(bytes=bytes, compression_type=compression_type, name=name)
DecodeCompressed.__doc__ = decode_compressed.__doc__
DecodeCompressed = _doc_controls.do_not_generate_docs(_kwarg_only(DecodeCompressed))
...
def decode_json_example(json_examples, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DecodeJSONExample", name, _ctx.post_execution_callbacks,
        json_examples)
      return _result
    except _core._FallbackException:
      try:
...
def DecodeJSONExample(json_examples, name=None):
  return decode_json_example(json_examples=json_examples, name=name)
DecodeJSONExample.__doc__ = decode_json_example.__doc__
DecodeJSONExample = _doc_controls.do_not_generate_docs(_kwarg_only(DecodeJSONExample))
...
def decode_padded_raw(input_bytes, fixed_length, out_type, little_endian=True, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DecodePaddedRaw", name, _ctx.post_execution_callbacks, input_bytes,
        fixed_length, "out_type", out_type, "little_endian", little_endian)
      return _result
    except _core._FallbackException:
      try:
  ...
  _execute.record_gradient(
      "DecodePaddedRaw", _inputs_flat, _attrs, _result, name)
  _result, = _result
  return _result

def DecodePaddedRaw(input_bytes, fixed_length, out_type, little_endian=True, name=None):
  return decode_padded_raw(input_bytes=input_bytes, fixed_length=fixed_length, out_type=out_type, little_endian=little_endian, name=name)
DecodePaddedRaw.__doc__ = decode_padded_raw.__doc__
DecodePaddedRaw = _doc_controls.do_not_generate_docs(_kwarg_only(DecodePaddedRaw))
tf_export("raw_ops.DecodePaddedRaw")(DecodePaddedRaw)


def decode_padded_raw_eager_fallback(input_bytes, fixed_length, out_type, little_endian=True, name=None, ctx=None):
  r"""This is the slowpath function for Eager mode.
  This is for function decode_padded_raw
  """
  _ctx = ctx if ctx else _context.context()
  out_type = _execute.make_type(out_type, "out_type")
  if little_endian is None:
...
def decode_raw(bytes, out_type, little_endian=True, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "DecodeRaw", name, _ctx.post_execution_callbacks, bytes, "out_type",
...
def DecodeRaw(bytes, out_type, little_endian=True, name=None):
  return decode_raw(bytes=bytes, out_type=out_type, little_endian=little_endian, name=name)
DecodeRaw.__doc__ = decode_raw.__doc__
DecodeRaw = _doc_controls.do_not_generate_docs(_kwarg_only(DecodeRaw))
...
def parse_example(serialized, names, sparse_keys, dense_keys, dense_defaults, sparse_types, dense_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseExample", name, _ctx.post_execution_callbacks, serialized,
...
def ParseExample(serialized, names, sparse_keys, dense_keys, dense_defaults, sparse_types, dense_shapes, name=None):
  return parse_example(serialized=serialized, names=names, sparse_keys=sparse_keys, dense_keys=dense_keys, dense_defaults=dense_defaults, sparse_types=sparse_types, dense_shapes=dense_shapes, name=name)
ParseExample.__doc__ = parse_example.__doc__
ParseExample = _doc_controls.do_not_generate_docs(_kwarg_only(ParseExample))
...
def parse_sequence_example(serialized, debug_name, context_dense_defaults, feature_list_dense_missing_assumed_empty, context_sparse_keys, context_dense_keys, feature_list_sparse_keys, feature_list_dense_keys, Ncontext_sparse=0, Ncontext_dense=0, Nfeature_list_sparse=0, Nfeature_list_dense=0, context_sparse_types=[], feature_list_dense_types=[], context_dense_shapes=[], feature_list_sparse_types=[], feature_list_dense_shapes=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseSequenceExample", name, _ctx.post_execution_callbacks,
        serialized, debug_name, context_dense_defaults,
        "feature_list_dense_missing_assumed_empty",
...
ParseSequenceExample.__doc__ = parse_sequence_example.__doc__
ParseSequenceExample = _doc_controls.do_not_generate_docs(_kwarg_only(ParseSequenceExample))
...
def parse_single_example(serialized, dense_defaults, num_sparse, sparse_keys, dense_keys, sparse_types, dense_shapes, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseSingleExample", name, _ctx.post_execution_callbacks, serialized,
        dense_defaults, "num_sparse", num_sparse, "sparse_keys", sparse_keys,
...
def ParseSingleExample(serialized, dense_defaults, num_sparse, sparse_keys, dense_keys, sparse_types, dense_shapes, name=None):
  return parse_single_example(serialized=serialized, dense_defaults=dense_defaults, num_sparse=num_sparse, sparse_keys=sparse_keys, dense_keys=dense_keys, sparse_types=sparse_types, dense_shapes=dense_shapes, name=name)
ParseSingleExample.__doc__ = parse_single_example.__doc__
ParseSingleExample = _doc_controls.do_not_generate_docs(_kwarg_only(ParseSingleExample))
...
def parse_single_sequence_example(serialized, feature_list_dense_missing_assumed_empty, context_sparse_keys, context_dense_keys, feature_list_sparse_keys, feature_list_dense_keys, context_dense_defaults, debug_name, context_sparse_types=[], feature_list_dense_types=[], context_dense_shapes=[], feature_list_sparse_types=[], feature_list_dense_shapes=[], name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseSingleSequenceExample", name, _ctx.post_execution_callbacks,
...
ParseSingleSequenceExample.__doc__ = parse_single_sequence_example.__doc__
ParseSingleSequenceExample = _doc_controls.do_not_generate_docs(_kwarg_only(ParseSingleSequenceExample))
...
def parse_tensor(serialized, out_type, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "ParseTensor", name, _ctx.post_execution_callbacks, serialized,
        "out_type", out_type)
      return _result
    except _core._FallbackException:
      try:
...
def ParseTensor(serialized, out_type, name=None):
  return parse_tensor(serialized=serialized, out_type=out_type, name=name)
ParseTensor.__doc__ = parse_tensor.__doc__
ParseTensor = _doc_controls.do_not_generate_docs(_kwarg_only(ParseTensor))
...
def serialize_tensor(tensor, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "SerializeTensor", name, _ctx.post_execution_callbacks, tensor)
      return _result
    except _core._FallbackException:
      try:
...
def SerializeTensor(tensor, name=None):
  return serialize_tensor(tensor=tensor, name=name)
SerializeTensor.__doc__ = serialize_tensor.__doc__
SerializeTensor = _doc_controls.do_not_generate_docs(_kwarg_only(SerializeTensor))
...
def string_to_number(string_tensor, out_type=_dtypes.float32, name=None):
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "StringToNumber", name, _ctx.post_execution_callbacks, string_tensor,
        "out_type", out_type)
      return _result
    except _core._FallbackException:
      try:
...
def StringToNumber(string_tensor, out_type=_dtypes.float32, name=None):
  return string_to_number(string_tensor=string_tensor, out_type=out_type, name=name)
StringToNumber.__doc__ = string_to_number.__doc__
StringToNumber = _doc_controls.do_not_generate_docs(_kwarg_only(StringToNumber))
